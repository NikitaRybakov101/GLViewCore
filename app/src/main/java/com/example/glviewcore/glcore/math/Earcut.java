...
public class Earcut {
    private static final String TAG = "INEarcut";
    ...
    private static void earcutLinked(Node ear,
    ...
    private static void splitEarcut(Node start,
                                    List<Integer> triangles,
                                    int dim,
                                    double minX,
                                    double minY,
    ...
    private static Node eliminateHoles(double[] data, int[] holeIndices, Node outerNode, int dim) {
        ...
        // TODO Заменено на это, т.к. "Call requires API level 24 (current min is 21): java.util.List#sort"
